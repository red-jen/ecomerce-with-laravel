                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full bg-white">
                            ...
                            <tbody>
                                @forelse($products as $product)
                                    <tr>
                                        ...
                                        <td class="py-2 px-4 border-b border-gray-200">
                                            ...
                                            <form class="inline-block" action="{{ route('admin.products.destroy', $product) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this product?');">
                                                @csrf
                                                @method('DELETE')
                                ...
                                @empty
                                    <tr>
                                        <td colspan="7" class="py-4 px-4 border-b border-gray-200 text-center text-gray-500">No products found</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
